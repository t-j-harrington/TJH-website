...
import uomCoatOfArms from '../../../assets/uom-coat-of-arms.svg';
import wasedaLogo from '../../../assets/waseda-logo.svg';
...
## <Image src={uomCoatOfArms} alt="University of Manchester coat of arms" width={48} style={logoStyle} />University of Manchester
...
### <Image src={wasedaLogo} alt="Waseda university logo" width={48} style={logoStyle} />Waseda university (早稲田大学)
