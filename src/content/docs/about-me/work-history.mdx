...
## <Image src={navroLogo} alt="Navro logo" width={48} style={logoStyle} />Navro <Badge text="November 2024 - Present" variant="tip" size="medium" />

I work for Navro as a Technical Writer.

Navro is a fintech company that provides global payment orchestration, helping businesses move money across borders through a single platform.

### Summary

Placeholder summary of my role and responsibilities at Navro.
